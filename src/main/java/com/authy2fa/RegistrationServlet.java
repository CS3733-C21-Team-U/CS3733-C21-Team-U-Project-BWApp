...
import com.authy2fa.AuthyApiClient;
//import com.authy2fa.exception.AuthyRequestException;
import com.authy2fa.lib.RequestParametersValidator;
import com.authy2fa.lib.SessionManager;
import com.authy2fa.AuthyRequestService;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (validateRequest(request)) {
            try {
                ...
                // TODO: Add authy user
                //userService.(new User(name, email, password, countryCode, phoneNumber, authyId));
