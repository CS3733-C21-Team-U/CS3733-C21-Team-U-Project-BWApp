...
public class DatabaseManager {
   ...
   */
  public int addNode(
      String node_id, int x, int y, int floor, String building, String longname, String shortname) {
    try {
      String str =
          "insert into Nodes (nodeID, xcoord, ycoord, floor, building, longname, shortname, 'U') values (?,?,?,?,?,?,?)";
      PreparedStatement ps = conn.prepareStatement(str);
