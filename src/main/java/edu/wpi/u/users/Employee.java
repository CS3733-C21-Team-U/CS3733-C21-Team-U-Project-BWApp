...
public class Employee extends User{
    ...
    public Employee(String employeeID, String name, String accountName, String password, String email,StaffType type, String phoneNumber,boolean deleted){
        super(employeeID, name,accountName,password,email,type, phoneNumber, deleted);
