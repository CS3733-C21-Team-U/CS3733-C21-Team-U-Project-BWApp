...
public class MainController {
  ...
  //Super important, the name of the vairble must be "[fxid]+Controller" where fxid matches in Mainveiw.fxml and Tab1.fxml
  ...
  @FXML
  private void advanceScene(ActionEvent e) throws Exception{
    Parent root = FXMLLoader.load(getClass().getResource("/edu/wpi/u/fxml/Scene2.fxml"));
