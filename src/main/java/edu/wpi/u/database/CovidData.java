...
public class CovidData extends Data{
    ...
    public void insertData(boolean result){
        String str;
        final Date sqlDate = Date.valueOf(todayDate);
    ...
    public int getWeeklySymptomaticSurveys(){
        ...
        final Date sqlTodayDate = Date.valueOf(todayDate);
        final Date sqlLastWeekDate = Date.valueOf(lastWeekDate);
        String str = "select count(symptomatic) from covidSurveyResult where (dateOfResults <= '" + sqlTodayDate + "' and dateOfResults >= '" + sqlLastWeekDate + "') and (symptomatic = true)";
        try{
            PreparedStatement ps = conn.prepareStatement(str);
            ResultSet rset = ps.executeQuery();
            rset.next();
    ...
    public int getWeeklySurveys(){
        ...
        final Date sqlTodayDate = Date.valueOf(todayDate);
        final Date sqlLastWeekDate = Date.valueOf(lastWeekDate);
        String str = "select count(symptomatic) from covidSurveyResult where dateOfResults <= '" + sqlTodayDate + "' and  dateOfResults >= '" + sqlLastWeekDate + "'";
        try{
            PreparedStatement ps = conn.prepareStatement(str);
            ResultSet rset = ps.executeQuery();
            rset.next();
    ...
    public int getWeeklyNonSymptomaticSurveys(){
        ...
        final Date sqlTodayDate = Date.valueOf(todayDate);
        final Date sqlLastWeekDate = Date.valueOf(lastWeekDate);
        String str = "select count(nonsymptomatic) from covidSurveyResult where (dateOfResults <= '" + sqlTodayDate + "' and dateOfResults >= '" + sqlLastWeekDate + "') and (nonsymptomatic = true)";
        try{
            PreparedStatement ps = conn.prepareStatement(str);
            ResultSet rset = ps.executeQuery();
            rset.next();
    ...
    public int getMonthlySurveys(){
        ...
        final Date sqlTodayDate = Date.valueOf(todayDate);
        final Date sqlLastMonthDate = Date.valueOf(lastMonthDate);
        String str = "select count(nonsymptomatic) from covidSurveyResult where (dateOfResults <= '" + sqlTodayDate + "' and dateOfResults >= '" + sqlLastMonthDate + "')";
        try{
            PreparedStatement ps = conn.prepareStatement(str);
            ResultSet rset = ps.executeQuery();
            rset.next();
    ...
    public int getMonthlyNonSymptomaticSurveys(){
        ...
        final Date sqlTodayDate = Date.valueOf(todayDate);
        final Date sqlLastMonthDate = Date.valueOf(lastMonthDate);
        String str = "select count(nonsymptomatic) from covidSurveyResult where (dateOfResults <= '" + sqlTodayDate + "' and dateOfResults >= '" + sqlLastMonthDate + "') and (nonsymptomatic = true)";
        try{
            PreparedStatement ps = conn.prepareStatement(str);
            ResultSet rset = ps.executeQuery();
            rset.next();
    ...
    public int getMonthlySymptomaticSurveys(){
        ...
        final Date sqlTodayDate = Date.valueOf(todayDate);
        final Date sqlLastMonthDate = Date.valueOf(lastMonthDate);
        String str = "select count(symptomatic) from covidSurveyResult where (dateOfResults <= '" + sqlTodayDate + "' and dateOfResults >= '" + sqlLastMonthDate + "') and (symptomatic = true)";
        try{
            PreparedStatement ps = conn.prepareStatement(str);
            ResultSet rset = ps.executeQuery();
            rset.next();
